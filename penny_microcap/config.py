...
class PennyConfig:
    strategy_version: str = "penny-shadow-v1"
    min_price: float = 1.0
    max_price: float = 49.99
    radar_history: int = 120
    confirming_history: int = 180
    ready_history: int = 260
    radar_turnover_lacs: float = 25.0
    confirming_turnover_lacs: float = 50.0
    ready_turnover_lacs: float = 100.0
    ready_recent_turnover_lacs: float = 200.0
